...
Graph json dont have code logic, it only have relationship logic.

How do I use my own graph? Let's continue in step _4_.

:::

## 4th Use my own Visual Prgraomming CMS
...
## 7th Create your own Canvas

1. visit http://localhost:3000/effectnode
